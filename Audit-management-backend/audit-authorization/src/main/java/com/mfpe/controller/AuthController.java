...
public class AuthController {
	...
	@ApiOperation(notes = "Returns running fine message", value = "Health Check")
	...
	@ApiOperation(notes = "Returns JWT token as response", value = "Generate JWT")
	...
	@ApiOperation(notes = "Returns user details extracted from JWT token", value = "Validate JWT")
